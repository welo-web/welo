...
<head>
  ...
  <title>نظام المدارس - ويلو ويب</title>
  <meta name="description" content="نظام إدارة المدارس المتكامل من ويلو ويب - إدارة الطلاب، المعلمين، المناهج والتقارير">
...
<body>
  ...
  <div class="hero-section">
    <div class="container">
      <h1 class="hero-title">نظام إدارة المدارس</h1>
      <p class="hero-subtitle">حل متكامل لإدارة مدرستك بكفاءة عالية</p>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="feature-card">
          ...
          <p class="feature-description">إدارة بيانات الطلاب والحضور والغياب</p>
        </div>
      </div>
      <div class="col-md-6">
        <div class="feature-card">
          <i class="fas fa-chalkboard-teacher feature-icon"></i>
          <h3 class="feature-title">إدارة المعلمين</h3>
          <p class="feature-description">إدارة شؤون المعلمين والجداول الدراسية</p>
        </div>
      </div>
      <div class="col-md-6">
        <div class="feature-card">
          <i class="fas fa-book feature-icon"></i>
          <h3 class="feature-title">إدارة المناهج</h3>
          <p class="feature-description">إدارة المناهج الدراسية والخطط التعليمية</p>
        </div>
      </div>
      <div class="col-md-6">
        <div class="feature-card">
          ...
          <p class="feature-description">تقارير تفصيلية عن الأداء والنتائج</p>
        </div>
      </div>
    </div>
      ...
      <div class="col-md-4">
        <div class="pricing-card">
          ...
          <ul class="pricing-features">
            ...
            <li><i class="fas fa-check"></i> إدارة المعلمين</li>
            <li><i class="fas fa-check"></i> إدارة المناهج</li>
            <li><i class="fas fa-check"></i> التقارير الأساسية</li>
          </ul>
          <a href="{{ route('subscriptions.create', ['service' => 'school', 'plan' => 'basic']) }}" class="btn-subscribe">اشترك الآن</a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="pricing-card">
          ...
          <div class="pricing-price">
            <span class="monthly-price">299 ريال</span>
            <span class="yearly-price" style="display: none">2,870 ريال</span>
            <span class="original yearly-price" style="display: none">3,588 ريال</span>
          </div>
          <div class="pricing-period">شهرياً</div>
          <ul class="pricing-features">
            <li><i class="fas fa-check"></i> كل مميزات الباقة الأساسية</li>
            <li><i class="fas fa-check"></i> تطبيق جوال للطلاب</li>
            <li><i class="fas fa-check"></i> نظام التواصل مع أولياء الأمور</li>
            <li><i class="fas fa-check"></i> التقارير المتقدمة</li>
            <li><i class="fas fa-check"></i> دعم فني متميز</li>
          </ul>
          <a href="{{ route('subscriptions.create', ['service' => 'school', 'plan' => 'advanced']) }}" class="btn-subscribe">اشترك الآن</a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="pricing-card">
          ...
          <ul class="pricing-features">
            ...
            <li><i class="fas fa-check"></i> تطبيق جوال للمعلمين</li>
          ...
          <a href="{{ route('subscriptions.create', ['service' => 'school', 'plan' => 'professional']) }}" class="btn-subscribe">اشترك الآن</a>
        </div>
      </div>
    </div>
