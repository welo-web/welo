...
<head>
  ...
  <title>نظام المطاعم - ويلو ويب</title>
  <meta name="description" content="نظام إدارة المطاعم المتكامل من ويلو ويب - إدارة الطلبات، المخزون، الموظفين والمبيعات">
...
<body>
  ...
  <div class="hero-section">
    <div class="container">
      <h1 class="hero-title">نظام إدارة المطاعم</h1>
      <p class="hero-subtitle">حل متكامل لإدارة مطعمك بكفاءة عالية</p>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="feature-card">
          ...
          <p class="feature-description">إدارة الطلبات والمبيعات اليومية بكفاءة</p>
        </div>
      </div>
      <div class="col-md-6">
        <div class="feature-card">
          ...
          <p class="feature-description">إدارة دقيقة للمخزون والمشتريات</p>
        </div>
      </div>
      <div class="col-md-6">
        <div class="feature-card">
      ...
      <div class="col-md-4">
        <div class="pricing-card">
          ...
          <ul class="pricing-features">
            ...
            <li><i class="fas fa-check"></i> إدارة القائمة</li>
            <li><i class="fas fa-check"></i> التقارير الأساسية</li>
          </ul>
          <a href="{{ route('subscriptions.create', ['service' => 'restaurant', 'plan' => 'basic']) }}" class="btn-subscribe">اشترك الآن</a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="pricing-card">
          ...
          <a href="{{ route('subscriptions.create', ['service' => 'restaurant', 'plan' => 'advanced']) }}" class="btn-subscribe">اشترك الآن</a>
        </div>
      </div>
      <div class="col-md-4">
        <div class="pricing-card">
          ...
          <ul class="pricing-features">
            ...
            <li><i class="fas fa-check"></i> إدارة الفروع</li>
            <li><i class="fas fa-check"></i> تطبيق الموبايل</li>
            <li><i class="fas fa-check"></i> دعم فني متميز</li>
          </ul>
          <a href="{{ route('subscriptions.create', ['service' => 'restaurant', 'plan' => 'professional']) }}" class="btn-subscribe">اشترك الآن</a>
        </div>
      </div>
    </div>
