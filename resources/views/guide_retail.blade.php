...
<head>
  ...
  <title>نظام المحلات - ويلو ويب</title>
  <meta name="description" content="نظام إدارة المحلات المتكامل من ويلو ويب - إدارة المبيعات، المخزون، العملاء والتقارير">
...
<div class="hero-section">
  <div class="container">
    <h1 class="hero-title">نظام إدارة المحلات</h1>
    <p class="hero-subtitle">حل متكامل لإدارة محلك بكفاءة عالية</p>
  </div>
</div>
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="feature-card">
        ...
        <p class="feature-description">إدارة المبيعات والمشتريات بسهولة</p>
      </div>
    </div>
    <div class="col-md-6">
      <div class="feature-card">
        ...
        <p class="feature-description">تتبع المخزون والمنتجات بفعالية</p>
      </div>
    </div>
    <div class="col-md-6">
      <div class="feature-card">
        ...
        <p class="feature-description">إدارة بيانات العملاء وتاريخ مشترياتهم</p>
      </div>
    </div>
    <div class="col-md-6">
      <div class="feature-card">
        ...
        <p class="feature-description">تقارير تفصيلية عن المبيعات والأرباح</p>
      </div>
    </div>
  </div>
            ...
            <div class="card pricing-card">
                <div class="card-body">
                    ...
                    <div class="price">
                        ...
                        <span class="yearly-price">1,911 ريال</span>
                        <span class="original-yearly-price">2,388 ريال</span>
                        <span class="period">/ شهرياً</span>
                    </div>
                    <ul class="features">
                        <li><i class="fas fa-check"></i> إدارة المبيعات</li>
                        <li><i class="fas fa-check"></i> إدارة المخزون</li>
                        <li><i class="fas fa-check"></i> التقارير الأساسية</li>
                    </ul>
                    <a href="{{ route('subscriptions.create', ['service' => 'retail', 'plan' => 'basic']) }}" class="btn btn-primary btn-block">اشترك الآن</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card pricing-card featured">
                <div class="card-body">
                    ...
                    <div class="price">
                        ...
                        <span class="yearly-price">3,831 ريال</span>
                        <span class="original-yearly-price">4,788 ريال</span>
                        <span class="period">/ شهرياً</span>
                    </div>
                    <ul class="features">
                    ...
                    <a href="{{ route('subscriptions.create', ['service' => 'retail', 'plan' => 'advanced']) }}" class="btn btn-primary btn-block">اشترك الآن</a>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card pricing-card">
                <div class="card-body">
                    ...
                    <div class="price">
                        ...
                        <span class="yearly-price">5,751 ريال</span>
                        <span class="original-yearly-price">7,188 ريال</span>
                        <span class="period">/ شهرياً</span>
                    </div>
                    <ul class="features">
                    ...
                    <a href="{{ route('subscriptions.create', ['service' => 'retail', 'plan' => 'professional']) }}" class="btn btn-primary btn-block">اشترك الآن</a>
                </div>
            </div>
        </div>
    </div>
